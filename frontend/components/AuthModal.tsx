    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm">
      <div className="glass-panel p-8 rounded-2xl max-w-md w-full mx-4 border-t border-cyan-500/30 bg-black/50">
        <div className="text-center mb-6">
          ...
          <h2 className="text-2xl font-bold text-white mb-2 font-header tracking-wide">Identify Yourself</h2>
        ...
        <button
          ...
          disabled={loading}
          className="w-full bg-white text-slate-900 hover:bg-slate-100 font-semibold py-3 px-4 rounded-lg flex items-center justify-center gap-3 transition-colors mb-4"
        >
          {loading ? (
        ...
        <p className="text-xs text-center text-slate-500 mt-6 font-mono">
          By continuing, you enable Jarvis to send the comprehensive PDF report to your inbox.
        </p>
      </div>
    </div>
  );
